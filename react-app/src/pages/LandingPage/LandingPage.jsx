...
function createData(ISIN, CUSIP, Issue_Name, Maturity_Date, Coupon, Type, Face_Value, Currency, Status) {
  return {
    ISIN,
    CUSIP,
    Issue_Name,
...
const rows = [
  createData('US0378331005', '037833100', 'Apple Inc.', '2025-01-01', '2.45%', 'Corporate Bond', '1000', 'USD', 'Active'),
  // Add more rows here...
];
