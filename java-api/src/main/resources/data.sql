...
INSERT INTO SECURITY(TRADE_CURRENCY, FACE_VALUE, BOND_MATURITY_DATE, CUSIP, ISIN, ISSUER_NAME,
  TRADE_STATUS, TRADE_TYPE, COUPON_PERCENT) VALUES
('USD', 1000, '2021-08-05', '         ','XS1988387210', 'BNPParibasIssu 4,37% Microsoft Corp (USD)', 'open', 'buy', 4.37),
('GBP', 1000, '2021-08-05', '         ','XS1988387210', 'BNPParibasIssu 4,37% Microsoft Corp (USD)', 'open', 'sell',4.37),
