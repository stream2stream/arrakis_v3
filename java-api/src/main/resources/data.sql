...
INSERT INTO SECURITY (ISIN, CUSIP, TYPE, ISSUER_NAME, SAMPLE_DATE, FACEVALUE, BONDCURRENCY, COUPON, STATUS)
SELECT ISIN, CUSIP, TYPE, ISSUER_NAME, BOND_MATURITY_DATE, "face_value (mn)", BOND_CURRENCY, COUPON_PERCENT, STATUS FROM TEST;


--UPDATE SECURITY SET MATURITY_DATE = PARSEDATETIME(SAMPLE_DATE, 'dd/mm/yyyy')
