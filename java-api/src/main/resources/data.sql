...
--Security Data
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (1,4.37,'USD','',1000,'XS1988387210','BNPParibasIssu 4,37% Microsoft Corp (USD)','2021-08-05','CORP','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (2,3.15,'USD','123456780',900,'USN0280EAR64','Airbus 3.15%  USD','2021-07-30','CORP','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date, type,status) VALUES (3,2,'USD','123456bh0',900,'A123456111','UBS Facebook (USD)','2021-09-30','CORP','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date, type,status) VALUES (4,2.02,'USD','87973RAA8',690,'US87973RAA86','TEMASEK FINL I LTD GLOBAL MEDIUM TERM NTS BOOK ENTRY REG S','2021-08-06','SOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (5,1.23,'USD','87973RAA8',340,'IE00B29LNP31','First Norway Alpha Kl.IV','2030-12-22','SOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (6,0.75,'GBP','BDCHBW8',900,'GB00B6460505','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (7,0.75,'GBP','BDCHBW8',900,'GB00B6460506','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (8,0.75,'GBP','BDCHBW8',900,'GB00B6460507','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (9,0.75,'GBP','BDCHBW8',900,'GB00B6460508','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (10,0.75,'GBP','BDCHBW8',900,'GB00B6460509','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (11,0.75,'GBP','BDCHBW8',900,'GB00B6460510','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (12,0.75,'GBP','BDCHBW8',900,'GB00B6460511','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (13,0.75,'GBP','BDCHBW8',900,'GB00B6460512','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (14,0.75,'GBP','BDCHBW8',900,'GB00B6460513','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (15,0.75,'GBP','BDCHBW8',900,'GB00B6460514','HM Treasury United Kingdon','2021-08-09','GOVN','active');
INSERT INTO security (id,coupon_percent,bond_currency,cusip, face_value, isin, issuer_name, bond_maturity_date,type,status) VALUES (16,0.75,'GBP','BDCHBW8',900,'GB00B6460515','HM Treasury United Kingdon','2021-08-09','GOVN','active');
