...
public interface TradeRepository extends JpaRepository<Trade, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT s.maturity_date, s.isin, s.currency, s.face_value, s.type, s.coupon, s.issuer_name, t.currency as t_curr, t.status, t.quantity, t.unit_price, t.buy_sell, t.trade_date, t.settlement_date, s.cusip from security s JOIN Trades t ON t.security_id = s.id AND t.book_id = :id")
